...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [PdfItem](./pdfsharp.pdf.pdfitem) → [PdfObject](./pdfsharp.pdf.pdfobject) → [PdfDictionary](./pdfsharp.pdf.pdfdictionary) → [PdfMarkedContentReference](./pdfsharp.pdf.structure.pdfmarkedcontentreference)<br>
...
Initializes a new instance of the [PdfMarkedContentReference](./pdfsharp.pdf.structure.pdfmarkedcontentreference) class.
