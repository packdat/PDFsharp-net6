...
```csharp
public sealed class PdfShadingPattern : PdfDictionaryWithContentStream, System.ICloneable, System.Collections.Generic.IEnumerable`1[[System.Collections.Generic.KeyValuePair`2[[System.String, System.Private.CoreLib, Version=6.0.0.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e],[PdfSharp.Pdf.PdfItem, PdfSharp, Version=0.1.3.0, Culture=neutral, PublicKeyToken=null]], System.Private.CoreLib, Version=6.0.0.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e]], System.Collections.IEnumerable, IContentStream
```

Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [PdfItem](./pdfsharp.pdf.pdfitem) → [PdfObject](./pdfsharp.pdf.pdfobject) → [PdfDictionary](./pdfsharp.pdf.pdfdictionary) → [PdfDictionaryWithContentStream](./pdfsharp.pdf.advanced.pdfdictionarywithcontentstream) → [PdfShadingPattern](./pdfsharp.pdf.advanced.pdfshadingpattern)<br>
...
Initializes a new instance of the [PdfShadingPattern](./pdfsharp.pdf.advanced.pdfshadingpattern) class.
...
### **SetupFromBrush(XLinearGradientBrush, XMatrix, XGraphicsPdfRenderer)**
...
`brush` [XLinearGradientBrush](./pdfsharp.drawing.xlineargradientbrush)<br>

`matrix` [XMatrix](./pdfsharp.drawing.xmatrix)<br>

`renderer` [XGraphicsPdfRenderer](./pdfsharp.drawing.pdf.xgraphicspdfrenderer)<br>
