...
Gets or sets the value of this field. This should be an item from the [PdfChoiceField.Options](./pdfsharp.pdf.acroforms.pdfchoicefield#options) list.<br>
