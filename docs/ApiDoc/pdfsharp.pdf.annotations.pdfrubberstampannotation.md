...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [PdfItem](./pdfsharp.pdf.pdfitem) → [PdfObject](./pdfsharp.pdf.pdfobject) → [PdfDictionary](./pdfsharp.pdf.pdfdictionary) → [PdfAnnotation](./pdfsharp.pdf.annotations.pdfannotation) → [PdfRubberStampAnnotation](./pdfsharp.pdf.annotations.pdfrubberstampannotation)<br>
...
[PdfRubberStampAnnotationIcon](./pdfsharp.pdf.annotations.pdfrubberstampannotationicon)<br>
...
Initializes a new instance of the [PdfRubberStampAnnotation](./pdfsharp.pdf.annotations.pdfrubberstampannotation) class.
