...
Gets or sets the value of this field. This should be an item from the [PdfRadioButtonField.Options](./pdfsharp.pdf.acroforms.pdfradiobuttonfield#options) list.<br>
...
Gets the option-names of this RadioButton<br>
 Use one of these values when setting [PdfRadioButtonField.Value](./pdfsharp.pdf.acroforms.pdfradiobuttonfield#value)<br>
 You cannot manipulate this collection directly.
 To change the elements you have to manipulate the [PdfAcroField.Annotations](./pdfsharp.pdf.acroforms.pdfacrofield#annotations) of this field.
...
Gets or sets the (optional) export-values for each entry in this radio button group.<br>
...
Gets or sets the (zero-based) index of the selected radio button in a radio button group.<br>
 Use -1 to deselect all items.<br>
 This is an alternative to the [PdfRadioButtonField.Value](./pdfsharp.pdf.acroforms.pdfradiobuttonfield#value)
...
### **AddAnnotation(String, Action&lt;PdfWidgetAnnotation&gt;)**
...
`nameOfOnState` [String](https://docs.microsoft.com/en-us/dotnet/api/system.string)<br>
