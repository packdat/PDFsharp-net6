...
namespace PdfSharp.Pdf.IO
{
    ...
    class Lexer
    {
        ...
        private long MoveToStartOfStream()
        {
            long pos;
        ...
        internal bool SearchEndOfStream(out long streamLength)
        {
        ...
        internal bool SearchForMarker(byte[] marker, out long markerPosition)
        {
            while (true)
            {
                var markerIndex = 0;
