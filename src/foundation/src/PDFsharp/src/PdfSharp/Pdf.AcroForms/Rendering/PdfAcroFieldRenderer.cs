namespace PdfSharp.Pdf.AcroForms.Rendering
{
    ...
    public class PdfAcroFieldRenderer
    {
        ...
        /// <summary>
        /// Gets or set the renderer for <see cref="PdfCheckBoxField"/>s
        ...
        /// <summary>
        /// Gets or set the renderer for <see cref="PdfComboBoxField"/>s
        /// <br></br>Trying to set this to null will throw an Exception
        /// </summary>
        ...
        /// <summary>
        /// Gets or set the renderer for <see cref="PdfListBoxField"/>s
        /// <br></br>Trying to set this to null will throw an Exception
        /// </summary>
        ...
        /// <summary>
        /// Gets or set the renderer for <see cref="PdfPushButtonField"/>s
        /// <br></br>Trying to set this to null will throw an Exception
        /// </summary>
        ...
        /// <summary>
        /// Gets or set the renderer for <see cref="PdfRadioButtonField"/>s
        /// <br></br>Trying to set this to null will throw an Exception
        /// </summary>
        ...
        /// <summary>
        /// Gets or set the renderer for <see cref="PdfSignatureField"/>s
        /// <br></br>Trying to set this to null will throw an Exception
        /// </summary>
        ...
        /// <summary>
        /// Gets or set the renderer for <see cref="PdfTextField"/>s
        /// <br></br>Trying to set this to null will throw an Exception
        /// </summary>
