...
namespace PdfSharp.Pdf.AcroForms.Rendering
{
    ...
    public class PdfPushButtonFieldRenderer
    {
        ...
        public virtual void RenderNormalState(PdfPushButtonField field, PdfWidgetAnnotation widget, XGraphics gfx, XRect rect)
        {
            ...
            {
                format = widget.CaptionPlacement == PdfWidgetAnnotation.CaptionPosition.LeftOfIcon
                ? XStringFormats.CenterLeft
                : widget.CaptionPlacement == PdfWidgetAnnotation.CaptionPosition.RightOfIcon
                    ? XStringFormats.CenterRight
                    : widget.CaptionPlacement == PdfWidgetAnnotation.CaptionPosition.AboveIcon
            ...
            if (widget.NormalIcon != null && widget.CaptionPlacement != PdfWidgetAnnotation.CaptionPosition.CaptionOnly)
                gfx.AppendToContentStream(PdfEncoders.RawEncoding.GetString(widget.NormalIcon.Stream.UnfilteredValue));

            if (widget.CaptionPlacement != PdfWidgetAnnotation.CaptionPosition.IconOnly)
